...
On our first ERCOT audit (esVolta Anole, 240 MW / 480 MWh), that reconciliation closed on 55.2% of discharge events overall, and 81.8% of major events — mean ratio 0.94.
...
Here is the part that matters: a ratio near 0.77 is what round-trip efficiency and auxiliary load produce if `soc` is denominated in total stored energy. A ratio near 0.94 is what you get if it is denominated in delivered energy. Both are ordinary. Neither is a defect.
